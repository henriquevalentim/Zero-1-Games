...
<body>
 ...
 <c:import url="fragmentos/navbarLogado.jsp" />
  ...
  <!-- Page Content -->
	...
	<c:if test="${ resultado != null && !ResultadoSalvarEndereco.msg.contains('sucesso') }">
	...
	<div class="row">
			...
			<div class="offset-md-4 col-md-4  form-group">
				<div class="form-check">
	  				<input class="form-check-input" type="checkbox" value="COBRANCA" name="txtEnderecoCobranca">
				...
				<div class="form-check">
	  				<input class="form-check-input" type="checkbox" value="ENTREGA" name="txtEnderecoEntrega" checked>
	  					<label class="form-check-label" for="defaultCheck1">
	    					Endereço de Entrega
	  					</label>
				</div>
