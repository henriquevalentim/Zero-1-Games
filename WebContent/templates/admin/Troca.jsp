...
<div class="container-fluid">
	...
	<form  action="ControleTrocaPedido" class="form-vertical" method="POST">
		<div class="row">
			...
			<table class="table  table-bordered table-hover">
				...
				<tbody>
					<c:forEach var="pedido" items="${ resultado.entidades }">
						<c:if test="${ pedido.statusPedido.id == 7 }">
							<tr>
								...
								<td class="text-center">
									...
									<a href="ControleTrocaPedido?btnOperacao=ALTERAR&idPedido=${ pedido.id }&txtStatus=${ pedido.statusPedido.id }&op=true&txtValor=${ pedido.subtotal }" class="badge badge-primary btn-xs">
										<i class="fa fa-check-circle" style="font-size: 20px;"></i>
									</a>
		
									<a href="ControleTrocaPedido?btnOperacao=ALTERAR&idPedido=${ pedido.id }&txtStatus=${ pedido.statusPedido.id }&op=false&txtValor=${ pedido.subtotal }" class="badge badge-warning btn-xs">
										<i class="fa fa-window-close" style="font-size: 20px;" ></i>
									</a>
									
									<a href="#" class="badge badge-secondary btn-xs">
