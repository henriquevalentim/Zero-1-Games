...
<div class="container-fluid">
	...
	<form  action="ControleEntregaPedido" class="form-vertical" method="POST">
		<div class="row">
			...
			<table class="table  table-bordered table-hover">
				...
				<tbody>
					<c:forEach var="pedido" items="${ resultado.entidades }">
						<c:if test="${ pedido.statusPedido.id == 3 }">
							<tr>
								...
								<td class="text-center">
									...
									<a href="ControleEntregaPedido?btnOperacao=ALTERAR&idPedido=${ pedido.id }&txtStatus=${ pedido.statusPedido.id }&op=true" class="badge badge-primary btn-xs">
										<i class="fa fa-check-circle" style="font-size: 20px;"></i>
									</a>
		
									<a href="ControleEntregaPedido?btnOperacao=ALTERAR&idPedido=${ pedido.id }&txtStatus=${ pedido.statusPedido.id }&op=false" class="badge badge-warning btn-xs">
